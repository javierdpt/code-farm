      ...
      left={
        <>
          ...
          >
            ...
            <span>Ops</span>
            <span
              className={`flex h-3.5 min-w-[22px] items-center justify-center rounded-full px-1 text-[9px] font-bold leading-none text-white transition-opacity ${
                unreadCount > 0 ? 'bg-blue-500 opacity-100' : 'opacity-0'
              }`}
            >
